...
1. Install Ollama
Download from https://ollama.com and verify:
...
Run the setup cells
Configure your Ollama URL (external server recommended for Colab)
...
👤 Author
Built as part of AIRI Team PITB — AI Internship Task 
End-to-End Agentic AI Project Assignment

#AgenticAI #Ollama #LocalLLM #Python 
